...
try {
    ...
    $sql = "
        SELECT
            id, visitDate, mat_id , clientName, tb_status,
            sex, current_status, clinician_name, clinical_notes, next_appointment,

            /*Clinical notes from nursing_history*/

            COALESCE(NULLIF(clinical_notes, ''), 'no previous_visit') AS clinical_notes,
...
<head>
    <meta charset="UTF-8">
    <title>nursing_history Appointment Schedule</title>
...
<div class="header">
    <div class="container">
        <h1 class="display-5 fw-bold">nursing_history Appointment Schedule</h1>
            ...
            <?php else: ?>
                <?php foreach ($appointments as $app): ?>
                    <tr>
                        ...
                        <td>
                            <a href="update_nursing_history_appointment.php?id=<?= $app['id'] ?>"

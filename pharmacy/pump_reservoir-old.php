                ...
                <div class="modal-body">
                    ...
                    <form id="dispenseForm" action="pump_reservoir.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" placeholder="milligrams" name="milligrams" id="milligrams" step="5" min="5" max="30000" required value="<?php echo isset($topup_form_values['milligrams']) ? $topup_form_values['milligrams'] : ''; ?>">
                        </div>

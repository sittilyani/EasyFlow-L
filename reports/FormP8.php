...
body { margin-left: 0.7in; margin-right: 0.7in; margin-top: 0.3in; margin-bottom: 0.75in; }
        ...
        <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
                ...
                <form action="process_FormP8.php" method="POST">
                    <tr class="row0">
                        <td class="column0">&nbsp;</td>
                        <td class="column1 style2 s"><img src="../assets/images/Kenyan_emblem.png" width="115" height="109" alt=""></td>
                    ...
                    <tr class="rowDate">
                        ...
                        <td class="column6 style1 s style2" colspan="3">
                        <input type="text" name="entryfacility" style="width: 300px; background-color: #d6eaf8;" placeholder="Enter Facility Name"></td>
                        <td class="column6 style1 s style2" colspan="3"><b>County:</b></td>
                        <td class="column6 style1 s style2" colspan="2"><input type="text" name="entrycounty" style="width: 300px; background-color: #d6eaf8;" placeholder="Enter County"></td>
                    </tr>
                    <tr class="rowDetails">
                        <td class="column0">&nbsp;</td>
                        <td class="column1 style1 s style3" colspan="3">Beginning Date:</b></td>
                    ...
                    <tr class="row23">
                        ...
                        <td class="column2 style27 s style29" colspan="3"><center><input type="text" name="pharmicName" style="width: 200px; background-color: #d6eaf8;" placeholder="Enter Full Name"></center></td>
                        ...
                        <td class="column7 style36 s style38" colspan="3"><center><input type="text" name="pharmicMobile" style="width: 200px; background-color: #d6eaf8;" placeholder="Enter Mobile Number;"></center></td>
                        <td class="column10 style39 s style39" colspan="2"><center><input type="date" name="pharmicDate" style="width: 200px; background-color: #d6eaf8;" Placeholder="Select Review Date;"></center></td>
                    </tr>
                    <tr class="row24">
                        <td class="column0">&nbsp;</td>

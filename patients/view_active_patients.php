...
<body>
    <h2 style="color: #2C3162; ">All Active Patients List</h2>
    ...
    <div class="header">
        ...
        Active:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/active_patient_count.php'; ?></span><br>
        <button
    ...
    $sql = "SELECT * FROM patients
            ...
            AND current_status = 'active' LIMIT 15";
    $sql = "
    SELECT
        patients.*,
    ...
    WHERE
        ...
        AND current_status IN ('Active', 'active')
";

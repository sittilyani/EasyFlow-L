...
<body>
    <h2 style="color: #2C3162; ">Defaulted Clients</h2>
    ...
    <div class="header">
        ...
        Defaulters:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/defaulted_patient_count.php'; ?></span><br>
        <button

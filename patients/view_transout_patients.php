...
<html>
<head>
    <title>Transfer Out patients</title>
...
<body>
    <h2 style="color: #2C3162; ">Transfer Out Clients</h2>
    ...
    <div class="header">
        ...
        Transfer Out:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/transout_patient_count.php'; ?></span><br>
        <button

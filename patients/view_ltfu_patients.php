...
<body>
    <h2 style="color: #2C3162; ">Lost to Follow Up Clients</h2>
    ...
    <div class="header">
        ...
        Lost to follow Up:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/lost_patient_count.php'; ?></span><br>
        <button

...
<body>
    <h2 style="color: #2C3162; ">Involuntary discontinuation (Stopped)</h2>
    ...
    <div class="header">
        ...
        Stopped by clinician:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/stopped_patient_count.php'; ?></span><br>
        <button

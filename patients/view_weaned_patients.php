...
<body>
    <h2 style="color: #2C3162; ">Weaned Clients</h2>
    ...
    <div class="header">
        ...
        Weaned:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/weaned_patient_count.php'; ?></span><br>
        <button
    ...
    SELECT
        ...
        COALESCE(DATEDIFF(CURDATE(), (SELECT MAX(visitDate) FROM pharmacy WHERE pharmacy.mat_id = patients.mat_id)), 0) AS days_weaned /*if not visitDate found in pharmacy table, return, 0*/
    FROM
        patients
    WHERE
        (mat_id LIKE '%$search%'

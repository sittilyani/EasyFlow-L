...
<html>
<head>
    <title>Voluntary discontinuation patients</title>
...
<body>
    <h2 style="color: #2C3162; ">Voluntary Discontinuation Clients</h2>
    ...
    <div class="header">
        ...
        Voluntary Discontinuation:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/voluntary_patient_count.php'; ?></span><br>
        <button
    ...
    WHERE
        ...
        AND current_status = 'voluntary discontinuation'
";

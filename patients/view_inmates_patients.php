...
<body>
    <h2 style="color: #2C3162; ">Clients in prisons</h2>
    ...
    <div class="header">
        ...
        Inmates:&nbsp;&nbsp;<span style="font-weight: normal; color: red;" ><?php include '../counts/inmates_patient_count.php'; ?></span><br>
        <button

<?php
    ...
    $average_dose_buprenorphine = 0;

    // Define the SQL query to count average patient doses on buprenorphine
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $average_dose_buprenorphine = $row['average_dose_buprenorphine'];
